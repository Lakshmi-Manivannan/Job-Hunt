...
public class RequestedServicesHelperClasses {
    ...
    public RequestedServicesHelperClasses(String username, String servicename, String location, String category, String user_img, String service_img, String timestamp, String servicenumber, String usernumber, String servicemail, String useremail,String
                                          description) {
        this.username = username;
        this.servicename = servicename;
        this.location = location;
